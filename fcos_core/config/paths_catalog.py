...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        'visdrone_daylight_train_cocostyle':{
                "img_dir": 'visdrone/adaptive/daylight/train/images',
                "ann_file": 'visdrone/adaptive/daylight/train.json',
        },
        'visdrone_daylight_val_cocostyle':{
                "img_dir": 'visdrone/adaptive/daylight/val/images',
                "ann_file": 'visdrone/adaptive/daylight/val.json',
        },
        'visdrone_night_train_cocostyle':{
                "img_dir": 'visdrone/adaptive/night/train/images',
                "ann_file": 'visdrone/adaptive/night/train.json',
        },
        'visdrone_night_val_cocostyle':{
                "img_dir": 'visdrone/adaptive/night/val/images',
                "ann_file": 'visdrone/adaptive/night/val.json',
        },
