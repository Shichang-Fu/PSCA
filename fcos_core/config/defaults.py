...
# MEMORY
_C.SOLVER.MEMORY = CN()
_C.SOLVER.MEMORY.BASE_LR = 0.005
_C.SOLVER.MEMORY.BIAS_LR_FACTOR = 2
_C.SOLVER.MEMORY.GAMMA = 0.1
_C.SOLVER.MEMORY.STEPS = (30000,)
_C.SOLVER.MEMORY.WARMUP_FACTOR = 1.0 / 3
_C.SOLVER.MEMORY.WARMUP_ITERS = 500
_C.SOLVER.MEMORY.WARMUP_METHOD = "linear"
# FUSION
_C.SOLVER.FUSION = CN()
_C.SOLVER.FUSION.BASE_LR = 0.005
_C.SOLVER.FUSION.BIAS_LR_FACTOR = 2
_C.SOLVER.FUSION.GAMMA = 0.1
_C.SOLVER.FUSION.STEPS = (30000,)
_C.SOLVER.FUSION.WARMUP_FACTOR = 1.0 / 3
_C.SOLVER.FUSION.WARMUP_ITERS = 500
_C.SOLVER.FUSION.WARMUP_METHOD = "linear"
...
##########################  Cfg ours ###########################
_C.MODEL.ADV.USE_MEMORY = False
_C.MODEL.ADV.USE_DIS_SCALE_CATEGORY = False
_C.MODEL.ADV.USE_MI = False
_C.MODEL.ADV.MI_FEATURE_SHAPES_P3 = (96,144)
_C.MODEL.ADV.MI_FEATURE_SHAPES_P4 = (48,72)
_C.MODEL.ADV.MI_FEATURE_SHAPES_P5 = (24,36)
_C.MODEL.ADV.MI_FEATURE_SHAPES_P6 = (12,18)
_C.MODEL.ADV.MI_FEATURE_SHAPES_P7 = (6,9)

_C.MODEL.ADV.USE_FUSION = False
_C.MODEL.ADV.USE_MI = False
_C.MODEL.ADV.USE_CONTRAST = False
_C.MODEL.ADV.USE_MEMORY_P7 = False
_C.MODEL.ADV.USE_MEMORY_P6 = False
_C.MODEL.ADV.USE_MEMORY_P5 = False
_C.MODEL.ADV.USE_MEMORY_P4 = False
_C.MODEL.ADV.USE_MEMORY_P3 = False


_C.MODEL.ADV.USE_FUSION_P7 = False
_C.MODEL.ADV.USE_FUSION_P6 = False
_C.MODEL.ADV.USE_FUSION_P5 = False
_C.MODEL.ADV.USE_FUSION_P4 = False
_C.MODEL.ADV.USE_FUSION_P3 = False

_C.MODEL.ADV.SCA_DIS_LAMBDA = 0.1
_C.MODEL.ADV.MI_LAMBDA = 0.1
_C.MODEL.ADV.CONTRAST_LAMBDA = 0.1